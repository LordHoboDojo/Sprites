...
public abstract class Sprite
{
	...
	public boolean isOverlapping(Sprite s){
		Point r1 = new Point((int)(this.x+this.getWidth()/2.0),(int)(this.y - this.getHeight()/2.0));
		Point l1 = new Point((int)(this.x-this.getWidth()/2.0),(int)(this.y + this.getHeight()/2.0));
		Point r2 = new Point((int)(s.x+s.getWidth()/2.0),(int)(s.y - s.getHeight()/2.0));
		Point l2 = new Point((int)(s.x-this.getWidth()/2.0),(int)(s.y + s.getHeight()/2.0));
